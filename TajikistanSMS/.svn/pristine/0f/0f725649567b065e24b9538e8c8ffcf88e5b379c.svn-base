...
public class FlaggedPatient {
	...
	public static String triggerName="flaggedJobTrigger";
	public static String triggerGroup="flaggedJob";
	public static String jobName="FlaggedPatient_job";
	public static String jobGroup="flaggedPatient";
	
	public FlaggedPatient(Scheduler schedu) throws ParseException{
		sched=schedu;
		reschedule_job=new JobDetail(jobName, jobGroup	,FlagPatientJob.class);
