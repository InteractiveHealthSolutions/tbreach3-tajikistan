...
public class QueryForm extends BaseTBReachForm implements CommandListener {
	...
	public void init() {
		...
		idField = new TextField( "Реги�?трационный номер пациента" , "" , 8 ,
				TextField.NUMERIC );
		idConfirm = new TextField( "Реги�?трационный номер пациента (повторить)" , "" , 8 ,
				TextField.NUMERIC );
		cmdOK = new Command( "Сабт" , Command.OK , 0 );
		cmdBack = new Command( "Ба аввал" , Command.BACK , 1 );
